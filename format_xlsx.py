...
def generate_key_sheet(xlsx_workbook, key_sheet_name='Key'):
    added_node_format = xlsx_workbook.add_format({'bg_color': '#00B0F0'})
    reordered_node_format = xlsx_workbook.add_format({'bg_color': '#92D050'})
    updated_element_format = xlsx_workbook.add_format({'bg_color': '#FFFF00'})

    added_node_text = 'Added nodes or columns'
    reordered_node_text = 'Re-ordered nodes'
    updated_element_text = 'Updated nodes'
